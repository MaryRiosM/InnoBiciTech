...
<br>
 <div class="container d-flex justify-content-center">
  ...
  <img src="IMG/urbana2.webp" class="card-img-top" alt="w-50 h-auto">
            <div class="card-body">

              <h5 class="card-title container d-flex justify-content-center" id="bicicleta">Plegable Acero 20P GW Copenhague</h5>


    <p class="card-textcontainer d-flex justify-content-center">$2.520.000</p>
  ...
  <div class="input-group mb-1 border-primary">
    ...
    <input type="number" class="form-control border-primary" id="valorBruto" value="2520000" readonly>
  </div>
  
  <div class="input-group mb-2">
    <span class="input-group-text border-primary bg-primary text-white">Valor total</span>
    <input type="number" class="form-control border-primary" id="valorTotal" value="2520000" readonly>
  </div>
  <a href="Inicio_sesion.php" onclick="guardarFactura()"><button type="button" class="mb-1 btn btn-danger btn-sm btn-block justify-content-center container">Comprar</button></a>
      ...
      <div class="accordion" id="accordionExample">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <p>La bicicleta plegable Copenhague, esta adecuada para uso cotidiano, con un diseño
                poco usual, es una bici que está por fuera de los diseños tradicionales, ya que en ella
                puedes desplazarte a cualquier lugar y la puedes guardar en cualquier espacio, su
                marco es de acero.</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              <ul>
                <li>Bicicleta plegable de 20" marca GW Copenhague Cosmos</li>
                <li>Con marco en acero 20"</li>
                <li>Rines en aluminio 20"</li>
                <li>Cambios Shimano.</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      window.onload = function(){
        ...
        document.getElementById('valorTotal').addEventListener('input',multiplicar);
      }
