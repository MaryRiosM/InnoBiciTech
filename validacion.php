        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6">
                    ...
                    <form class="border p-4 rounded justify-content-center text-center">
    
                        <h2 class="mb-4 text-center text-dark">Validación de Correo</h2>
                        <h6 class="mb-4 text-center text-dark">Ingresa el codigo de 6 digitos que ha llegado a tu correo</h6>
    
                        <div class="form-group justify-content-center  text-center">
                            <label for="contrasena" class="text-dark">Ingresar codigo</label>
                            <input type="password" class="form-control text-center" id="contrasena" placeholder="Codigo">
                        </div>
    <br>
                        <a href="Nueva_contraseña.php">
                            <button type="button" type="submit" class="btn btn-primary btn-block text-center">Validar</button>
                        </a>
