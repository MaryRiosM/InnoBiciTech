...
<br>
 <div class="container d-flex justify-content-center">
  ...
  <img src="IMG/bici 8.jpg" class="card-img-top" alt="w-50 h-auto">
            <div class="card-body">

              <!-- cambio• -->
              <h5 class="card-title container d-flex justify-content-center" id="bicicleta">Especializada Epic Hardtail</h5>
    
    
    <p class="card-textcontainer d-flex justify-content-center">$9.990.000</p>
  ...
  <div class="input-group mb-1 border-primary">
    ...
    <input type="number" class="form-control border-primary" id="valorBruto" value="9990000" readonly>
  </div>
  
  <div class="input-group mb-2">
    <span class="input-group-text border-primary bg-primary text-white">Valor total</span>
    <input type="number" class="form-control border-primary" id="valorTotal" value="9990000" readonly>
  </div>
  <!-- cambio• -->
      ...
      <div class="accordion" id="accordionExample">
        ...
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <p>Prepárate para conseguir mucho más sobre la Epic Hardtail. Rápida y ligera unido a la confianza y alta capacidad en una bicicleta que ha sido creada para redefinir lo que es posible en una bici de cross-country.</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              <ul>
                <li>Frameset: Specialized FACT 11m, Progressive XC Geometry, Rider-First Engineered™, threaded BB, 12x148mm rear spacing, internal cable routing</li>
                <li>Suspension: RockShox Judy Gold, Motion Control damper, Solo Air, 42mm offset, 15x110mm thru-axle, 100mm of travel (XS - 80mm travel)</li>
                <li>FRENO DELANTERO SRAM Level T hydraulic disc, 2-Piston Caliper</li>
                <li> FRENO TRASERO SRAM Level T hydraulic disc, 2-Piston Caliper</li>
              </ul>
            </div>
          </div>
        </div>
