            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-md-6 text-center">
                    ...
                    <form class="border p-4 rounded">
                        ...
                        <h2 class="mb-4 text-center text-dark">Recuperar tus Datos</h2>
                        <h6 class="mb-4 text-center text-dark">Ingresa el correo electrónico registrado para enviarte un mensaje con un enlace para recuperar tu contraseña</h6>
    
                        <div class="form-group justify-content-center text-center text-dark">
                            <label for="contrasena" class="text-dark"></label>
                            <input class="form-control text-center" id="contrasena" placeholder="Correo Electrónico">
                        </div>
    <br>
                        <a href="validacion.php">
                            <button type="button"type="submit" class="btn btn-primary btn-block col-md-6 text-center text-center mb-0">Recuperar Sesión</button>
