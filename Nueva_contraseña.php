            ...
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    ...
                    <form class="border p-4 rounded">
                        ...
                        <h2 class="mb-4 text-center text-dark">Nueva Contraseña</h2>
                        <h6 class="mb-4 text-center text-dark">Ingresa una nueva clave con numeros y letras</h6>
    
                        <div class="form-group justify-content-center  text-center">
                            <label for="contrasena text-dark">Ingresar Nueva Contraseña</label>
                            <input type="password" class="form-control text-center" id="contrasena" placeholder="Contraseña">
                        </div>
    <br>
                        <a href="Inicio_sesion.php">
                            <button type="button" type="submit" class="btn btn-primary btn-block">Recuperar</button>
                        </a>
