...
<br>
 <div class="container d-flex justify-content-center">
  ...
  <img src="IMG/ruta3.webp" class="card-img-top" alt="w-50 h-auto">
            <div class="card-body">
<!-- cambio• -->
<h5 class="card-title container d-flex justify-content-center" id="bicicleta">Bicicleta Flamma Ruta GW</h5>
   


    <p class="card-textcontainer d-flex justify-content-center">$3.322.600</p>
  ...
  <div class="input-group mb-1 border-primary">
    ...
    <input type="number" class="form-control border-primary" id="valorBruto" value="3322600" readonly>
  </div>
  
  <div class="input-group mb-2">
    <span class="input-group-text border-primary bg-primary text-white">Valor total</span>
    <input type="number" class="form-control border-primary" id="valorTotal" value="33322600" readonly>
  </div>
  <!-- cambio•• -->
      ...
      <div class="accordion" id="accordionExample">
        ...
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <p>La bicicleta de ruta Flamma es ligera, práctica y estéticamente atractiva, ideal para
                empezar a asumir nuevos retos, experimentar nuevos caminos en ruta y mejorar tu nivel de resistencia. Su marco es en aluminio ultra liviano y su tenedor en carbono, su geometría escaladora es lo que le da el toque para sentirte seguro y ganador.</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              <ul>
                <li>Bicicleta de ruta FLAMMA de 10 velocidades</li>
                <li>Con marco FLAMMA en aluminio + tenedor en carbón</li>
                <li>Grupo Shimano Tiagra de 10Vel</li>
                <li>Marca GW</li>
              </ul>
            </div>
          </div>
