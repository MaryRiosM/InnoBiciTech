...
<br>
 <div class="container d-flex justify-content-center">
  ...
  <img src="IMG/ruta2.webp" class="card-img-top" alt="w-50 h-auto">
            <div class="card-body">
    <h5 class="card-title container d-flex justify-content-center" id="bicicleta">Ventoux Ruta</h5>
    <p class="card-textcontainer d-flex justify-content-center">$2.250.000</p>
  ...
  <div class="input-group mb-1 border-primary">
    ...
    <input type="number" class="form-control border-primary" id="valorBruto" value="2250000" readonly>
  </div>
  
  <div class="input-group mb-2">
    <span class="input-group-text border-primary bg-primary text-white">Valor total</span>
    <input type="number" class="form-control border-primary" id="valorTotal" value="2250000" readonly>
  </div>
  <a href="Inicio_sesion.php" onclick="guardarfactuta()"><button type="button" class="mb-1 btn btn-danger btn-block justify-content-center container">Comprar</button></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="accordion" id="accordionExample">
        ...
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              <p>La bicicleta de ruta Ventoux está preparada para la velocidad que quieras darle en las
                rutas, andar largos caminos y acompañarte a subir cada día más de nivel, su complicidad te generará alta confianza y te garantiza estabilidad. Su marco está fabricado en aluminio ultra liviano con cableado interno y su tenedor en carbono, su geometría escaladora te ayudará a dar un paso más hacia adelante.</p>
            </div>
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              <ul>
                <li>Bicicleta de ruta Ventoux GW </li>
                <li>Material: Aluminio con tenedor en carbono</li>
                <li>Marco hidroformado con cableado interno</li>
                <li>Grupo SHIMANO TIAGRA 10V 34/50 Compact</li>
                <li>Accesorios GW en Aluminio</li>
                <li>Llantas Chaoyang ATTACK 700*25 </li>
                <li>Rines GW Dark black 700C</li>
                <li>Peso 10 kg en M</li>
              </ul>
            </div>
          </div>
        </div>
